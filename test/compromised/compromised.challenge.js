...
describe('Compromised challenge', function () {
    ...
    it('Exploit', async function () {        
        ...
        console.log("NFT price before attack: ", String(await this.oracle.getMedianPrice(tokenSymbol)).slice(0, -18));
        ...
        console.log("NFT price when selling: ", String(await this.oracle.getMedianPrice(tokenSymbol)).slice(0, -18));
        ...
        console.log("NFT price after attack: ", String(await this.oracle.getMedianPrice(tokenSymbol)).slice(0, -18));
